              ...
              >
                ...
                <div className="space-y-6 text-slate-300 leading-relaxed">
                  ...
                  <p>
                    ...
                    각도와 거리를 입력하면, 보이저호의 메시지처럼, 여러 기록을
                    조합해 위치를 추정할 수 있는 구조가 됩니다.
                  </p>
                  <p>
                    특히 이 좌표를 활용하는 방랑자의 선택과, 쇼엔의 선견력을
                    바탕으로 나타난 종이새 시라토리의 인도가 더해지며
                    엑소스트라이더의 위치를 찾아낼 수 있었습니다.
                  </p>
                </div>
              </Card>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="text-slate-300 leading-relaxed">
                  쇼엔의 선견력을 통해 미래의 가능성을 빌려오고, 그 힘으로
                  나타난 종이새 시라토리를 길잡이로 삼아 방랑자를 인도하는
                  인물입니다. 블랙홀에서 형성된 구 형태의 좌표를 해석하고,
                  방랑자가 나아갈 수 있는 경로를 제시함으로써 결전으로 향하는
                  길을 열어줍니다.
                </p>
              </Card>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="bg-card/50 backdrop-blur border-border/50 p-8 hover:border-accent/50 transition-all duration-300 animate-fade-in">
                ...
                <p className="text-slate-300 text-sm">
                  블랙홀 파트의 음악은 절망 속에서도 앞으로 나아가는 사람들의
                  의지와 희생을 감동적으로 드러냅니다. 블랙홀이라는 공간은 모든
                  것을 삼키는 허무를 상징하지만, 이 장면의 음악은 공포보다도
                  사라져가는 사람들이 마지막까지 남긴 의지와 희망을 강조합니다.
                  수많은 주파수가 모여 하나의 좌표가 되는 장면은 개인의 작은
                  선택들이 모여 영웅을 인도하는 길이 되는 순간입니다. 음악은 이
                  감정을 차분하면서도 장엄하게 끌어올리며, “세계가 영웅을
                  구한다”는 3.3 스토리의 인간찬가적 주제를 완성합니다.
                </p>
              </Card>
              ...
              >
                ...
                <p className="text-slate-300 text-sm">
                  이 장면의 음악은 절망적인 상황이 희망으로 전환되는 감정을
                  강하게 표현합니다. 핵심 코어가 없어 무너져가던
                  엑소스트라이더가 리액터 드라이브 레플리카를 통해 다시 움직이기
                  시작하는 순간, 음악은 단순한 메카닉의 재기동이 아니라 인류가
                  포기하지 않고 만들어낸 희망이 다시 심장을 얻는 장면처럼
                  느껴지게 만듭니다. 특히 앞선 블랙홀 파트에서 쌓아온 수많은
                  사람들의 주파수와 희생, 연구팀의 노력, 에이메스의 선택이 이
                  순간 하나로 모이면서 각성 장면의 감정적 무게가 커집니다.
                  그래서 이 BGM은 전투를 고조시키는 배경음악을 넘어, 세계가
                  영웅을 구하기 위해 쌓아온 모든 의지가 엑소스트라이더를 다시
                  일으켜 세우는 순간을 장대하게 완성합니다.
                </p>
              </Card>
            </div>
          </div>
